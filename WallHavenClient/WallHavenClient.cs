...
public class WallHavenClient : IWallHavenClient
{
    ...
    public async Task<WallHavenResponse> GetWallpaper(string wallpaperId)
    {
        ...
        return responseObject is not null ? responseObject : throw new NotFoundException($"Wallpaper ID: {wallpaperId}");
    }
    ...
    public async Task<WallHavenResponse> Search(string searchParams)
    {
        ...
        return responseObject is not null ? responseObject : throw new DeserializeException($"Search Params Used: {searchParams}");
    }
}